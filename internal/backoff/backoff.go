...
// AfterFunc calls AfterFunc on the time package with the duration of the n'th wait cycle'
func (b Policy) AfterFunc(n int, f func()) {
	time.AfterFunc(b.Duration(n), f)
}
