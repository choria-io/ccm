...
title = "The Agent"
weight = 50
description = "The background loop that applies manifests on a timer, watches remote sources, refreshes facts and data, and remediates failing health checks."
+++
