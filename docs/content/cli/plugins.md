...
Since version `0.12.0` of App Builder it includes the ability to invoke CCM manifests from input provided in flags, arguments and interactive form wizards.